...
**SpliceKit** is a one-time payment of **$0** on the **Mac App Store**.

> [:icon-desktop-download: Click here to **buy** on the **Mac App Store**](NA)
...
You can use **SpliceKit** to "unlock" CommandPost!
