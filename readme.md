...
> [:icon-desktop-download: Click here to download!](/download/)

Whilst powerful tools like [CommandPost](https://commandpost.fcp.cafe) have existed for a decade, SpliceKit uses `dylib` code injection to get inside Final Cut Pro, giving you complete control.

SpliceKit loads a custom framework directly inside Final Cut Pro's process space giving you full access to all **78,000+ Objective-C classes** and their methods through a JSON-RPC interface and MCP server.
